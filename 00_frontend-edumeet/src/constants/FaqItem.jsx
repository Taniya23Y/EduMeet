  ...
  return (
    <div className="relative z-2 mb-16">
      ...
      >
        ...
        <div
          className={clsx(
            "faq-icon relative flex size-12 items-center justify-center rounded-full border-2 border-yellow shadow-400 transition-all duration-500 group-hover:border-[#652d23]",
