...
export default function Cursor({ visible }) {
  ...
  return (
    <div
      ref={curs}
      className={`cursor pointer-events-none fixed left-1/2 top-1/2 z-[999] ${
        visible ? "flex" : "hidden"
      } h-3 w-3 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-[#0DA34E]`}
