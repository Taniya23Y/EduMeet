...
const ButtonOnly = ({ children, active }) => {
  return (
    <div
      className={`relative cursor-pointer text-center underline text-[13px] sm:text-[16px] px-6 py-3 rounded-tl-2xl rounded-br-2xl rounded-tr-2xl font-bold shadow-[2px_2px_0px_0px_rgba(255,255,255,0.18)]
