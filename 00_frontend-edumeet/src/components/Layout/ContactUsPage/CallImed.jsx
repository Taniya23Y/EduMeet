  ...
  return (
    <div className="flex flex-col gap-6 rounded-xl bg-richblack-800 p-4 lg:p-6">
      <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
        ...
        <p className="font-semibold">info@edumeet.com</p>
      </div>
      <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
        <div className="flex flex-row items-center gap-3">
          <svg
        ...
        <p className="font-semibold">
          123 Greenway Street, Sector 45, Indore, Madhya Pradesh, 452001, India
        </p>
      </div>
      <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
        <div className="flex flex-row items-center gap-3">
        ...
        <p className="font-medium text-gray-200">Mon - Fri From 8am to 5pm</p>
        <p className="font-semibold">+91 6366 xxx xxx</p>
      </div>
    </div>
  );
};
