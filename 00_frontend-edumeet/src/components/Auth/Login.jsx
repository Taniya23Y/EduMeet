...
import { FaArrowRight, FaEnvelope, FaLock, FcGoogle } from "../../assets/icons";
import logo from "../../assets/logo.png";
import loginImage from "../../assets/edumeet-yellow-logo-removebg-preview.png";
            ...
            <div className="flex flex-row items-center justify-start ">
              <div>
                <p className="text-[1rem] font-serif">
                  Are you hungry? Don`&apos`t wait.
                </p>
                <p className="text-[1rem] font-serif">
                  Let`&apos`s start to order now.
                </p>
              </div>
              <div>
                <img
